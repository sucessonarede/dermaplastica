...
### October 13, 2025
- **Added discount pricing system**: Implemented comprehensive discount pricing for procedures. Added optional "Preço c/ Desconto (Unid/mL)" field to procedure forms. When a procedure has a discounted price, the procedure card displays the original price with strikethrough and the discounted price in green. QuoteBuilder automatically uses discounted prices in subtotal calculations (priority: customPrice > discountedPrice > mlPrice/basePrice). Presentation shows both prices with visual distinction - original price strikethrough and discounted price highlighted. This creates a compelling value proposition when presenting to patients.
